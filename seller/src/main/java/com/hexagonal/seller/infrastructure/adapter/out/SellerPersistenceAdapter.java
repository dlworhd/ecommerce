package com.hexagonal.seller.infrastructure.adapter.out;

import com.hexagonal.seller.application.port.out.SellerPersistencePort;
import com.hexagonal.seller.domain.Seller;
import com.hexagonal.seller.infrastructure.jpa.SellerEntity;
import com.hexagonal.seller.infrastructure.jpa.SellerRepository;
import com.hexagonal.seller.infrastructure.jpa.SellerStatus;
